...
MaruA1["1"] = Instance.new("ScreenGui", game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui"));
MaruA1["1"]["ZIndexBehavior"] = Enum.ZIndexBehavior.Sibling;

MaruA1["2"] = Instance.new("Frame", MaruA1["1"]);
MaruA1["2"]["BorderSizePixel"] = 0;
MaruA1["2"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0);
MaruA1["2"]["Size"] = UDim2.new(0, 50, 0, 50);
MaruA1["2"]["Draggable"] = true
MaruA1["2"]["Position"] = UDim2.new(0.20, 0, -0.1, 0);
MaruA1["2"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);


MaruA1["3"] = Instance.new("UICorner", MaruA1["2"]);
MaruA1["3"]["CornerRadius"] = UDim.new(1, 0);

MaruA1["4"] = Instance.new("TextButton", MaruA1["2"]);
MaruA1["4"]["TextWrapped"] = true;
MaruA1["4"]["BorderSizePixel"] = 0;
MaruA1["4"]["TextSize"] = 14;
MaruA1["4"]["TextColor3"] = Color3.fromRGB(255, 255, 255);
MaruA1["4"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
MaruA1["4"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
MaruA1["4"]["Size"] = UDim2.new(0, 50, 0, 56);
MaruA1["4"]["BackgroundTransparency"] = 1;
MaruA1["4"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
MaruA1["4"]["Text"] = [[STOP TWEEN]];
MaruA1["4"]["Position"] = UDim2.new(0, 0, -0.07273, 0);
MaruA1["5"] = Instance.new("UIStroke", MaruA1["4"]);
MaruA1["5"]["Color"] = Color3.fromRGB(255, 0, 0);

MaruA1["6"] = Instance.new("UIStroke", MaruA1["2"]);
MaruA1["6"]["Color"] = Color3.fromRGB(169, 238, 8);
...
MaruA1["4"].MouseButton1Click:Connect(function()
    StopTween()
end)
...
_G.Title = "Maru Hub Script blox fruits" -- คำอธิบาย
-----------------------------------------------------------------
...
ImageButton.Image = "rbxassetid://128503934326751"
