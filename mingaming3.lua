...
v3.Window = function(v110, v111)
	...
	v146.Image = "http://www.roblox.com/asset/?id="   .. tostring(123910544456037) ;
...
v6.Image = "rbxassetid:// 123910544456037";
v6.Draggable = true;
...
v7.Parent = v6;
if (game.PlaceId == 123910544456037) then
	World1 = true;
elseif (game.PlaceId == 123910544456037) then
	World2 = true;
elseif (game.PlaceId == 123910544456037) then
	World3 = true;
end
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "Ronbon",
	Text = "Loading Done!",
	Icon = "rbxthumb://type=Asset&id= 123910544456037w=150&h=150",
	Duration = 10
});