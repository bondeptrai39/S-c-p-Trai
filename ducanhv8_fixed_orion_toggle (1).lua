...
local Window = OrionLib:MakeWindow({
	Title = "Đức Anh Android Hub",
	Author = "Premium script",
	Folder = "Đức Anh Android",
...
-- ====== Added Orion Tabs (Farming, Stats, Shop, Misc, Settings) ======
local FarmingTab = Window:MakeTab({
    Name = "Farming",
    Icon = "rbxassetid://1234567890", -- replace with your icon ID
    PremiumOnly = false
})
FarmingTab:AddLabel("Farming Menu")
FarmingTab:AddButton({
    Name = "Auto Farm (demo)",
    Callback = function()
        print("Auto Farm pressed")
    end
})
...
SettingsTab:AddLabel("Settings Menu")

-- Initialize Orion UI (if not initialized elsewhere)
...
-- ImageButton block removed (migrated to Orion tabs)
...
(getgenv()).Load = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Đức Anh Android Hub New") then
			makefolder("Đức Anh Android Hub New");
		end;
		if not isfolder("Đức Anh Android  Hub New/Blox Fruits/") then
			makefolder("Đức Anh Android  Hub New/Blox Fruits/");
		end;
		if not isfile(("Đức Anh Android  Hub New/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("Đức Anh Android  Hub New/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(_G.Settings));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("Đức Anh Android  Hub New/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveSetting = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("Đức Anh Android  Hub New/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("Đức Anh Android  Hub New/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
-- ====== Added ImageButton Toggle (Xeter style) ======
local button = Instance.new("ImageButton")
button.Size = UDim2.new(0, 45, 0, 45)
button.Position = UDim2.new(0, 10, 0, 200) -- vị trí góc trái màn hình
button.Image = "rbxassetid://1234567890 -- replaced invalid asset id" -- 👈 icon mặc định (có thể đổi)
