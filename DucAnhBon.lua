...
DucanhbonA1["1"] = Instance.new("ScreenGui", game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui"));
    DucanhbonA1["1"]["ZIndexBehavior"] = Enum.ZIndexBehavior.Sibling;

DucanhbonA1["2"] = Instance.new("Frame", DucanhbonA1["1"]);
DucanhbonA1["2"]["BorderSizePixel"] = 0;
DucanhbonA1["2"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0);
DucanhbonA1["2"]["Size"] = UDim2.new(0, 50, 0, 50);
DucanhbonA1["2"]["Draggable"] = true
DucanhbonA1["2"]["Position"] = UDim2.new(0.20, 0, -0.1, 0);
DucanhbonA1["2"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);


DucanhbonA1["3"] = Instance.new("UICorner", DucanhbonA1["2"]);
DucanhbonA1["3"]["CornerRadius"] = UDim.new(1, 0);

DucanhbonA1["4"] = Instance.new("TextButton", DucanhbonA1["2"]);
DucanhbonA1["4"]["TextWrapped"] = true;
DucanhbonA1["4"]["BorderSizePixel"] = 0;
DucanhbonA1["4"]["TextSize"] = 14;
DucanhbonA1["4"]["TextColor3"] = Color3.fromRGB(255, 255, 255);
DucanhbonA1["4"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
DucanhbonA1["4"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
DucanhbonA1["4"]["Size"] = UDim2.new(0, 50, 0, 56);
DucanhbonA1["4"]["BackgroundTransparency"] = 1;
DucanhbonA1["4"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
DucanhbonA1["4"]["Text"] = [[STOP TWEEN]];
DucanhbonA1["4"]["Position"] = UDim2.new(0, 0, -0.07273, 0);
DucanhbonA1["5"] = Instance.new("UIStroke", DucanhbonA1["4"]);
DucanhbonA1["5"]["Color"] = Color3.fromRGB(255, 0, 0);

DucanhbonA1["6"] = Instance.new("UIStroke", DucanhbonA1["2"]);
DucanhbonA1["6"]["Color"] = Color3.fromRGB(169, 238, 8);
...
DucanhbonA1["4"].MouseButton1Click:Connect(function()
    StopTween()
end)
...
_G.Title = "Ducanhbon Hub Script blox fruits" -- คำอธิบาย
-----------------------------------------------------------------
...
ImageButton.Image = "rbxassetid://85794713546220"
