...
v3.Window = function(v110, v111)
	...
	v146.Image = "http://www.roblox.com/asset/?id="   .. tostring(137973397101287) ;
...
v6.Image = "rbxassetid://137973397101287";
v6.Draggable = true;
...
v39:Button("Kaitun Cap", function(v462)
	...
	for v858, v859 in pairs(v463) do
		if (v486[v859] and (game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy"   .. v859 , true) == 1)) then
			...
			v1570.Image = "rbxassetid://137973397101287";
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	...
	Text = "Loading Done!",
	Icon = "rbxthumb://type=Asset&id=137973397101287&w=150&h=150",
	Duration = 10
});