...
task.wait(1)
Notification.new("<Color=Yellow>Đức Anh Android<Color=/>"):Display()
task.wait(5)
...
-- Tùy chỉnh
local TEXT = "Fast Attack By Đức Anh Android Roblox"
...
local function createBillboardFor(character)
    ...
    local existing = head:FindFirstChild("Đức Anh Android_FastAttack_Label")
    if existing then existing:Destroy() end

    local billboard = Instance.new("BillboardGui")
    billboard.Name = "Đức Anh Android_FastAttack_Label"
...
_G.NameHub = "By Đức Anh Android Roblox" -- ชื่อ Hub
_G.Title = "Đức Anh Android Hub" -- คำอธิบาย
-----------------------------------------------------------------
...
ImageButton.Image = "rbxassetid://88041179982840"
...
Discord.MouseButton1Click:Connect(function()
    (setclipboard or toclipboard)("=ZS-8ynuCFNpQyg&_r=1")
    wait(.1)
...
game:GetService("StarterGui"):SetCore(
    "SendNotification",
    {
        ...
        Text = "Đã Tải Xong",
        Icon = "rbxassetid://88041179982840",
        Duration = 5
    }
)
