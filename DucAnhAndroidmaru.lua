local Đức Anh Android A1 = {};

Đức Anh Android A1["1"] = Instance.new("ScreenGui", game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui"));
Đức Anh Android A1["1"]["ZIndexBehavior"] = Enum.ZIndexBehavior.Sibling;

Đức Anh Android A1["2"] = Instance.new("Frame", Đức Anh Android A1["1"]);
Đức Anh Android A1["2"]["BorderSizePixel"] = 0;
Đức Anh Android A1["2"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0);
Đức Anh Android A1["2"]["Size"] = UDim2.new(0, 50, 0, 50);
Đức Anh Android A1["2"]["Draggable"] = true
Đức Anh Android A1["2"]["Position"] = UDim2.new(0.20, 0, -0.1, 0);
Đức Anh Android A1["2"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);


Đức Anh Android A1["3"] = Instance.new("UICorner", Đức Anh Android A1["2"]);
Đức Anh Android A1["3"]["CornerRadius"] = UDim.new(1, 0);

Đức Anh Android A1["4"] = Instance.new("TextButton", Đức Anh Android A1["2"]);
Đức Anh Android A1["4"]["TextWrapped"] = true;
Đức Anh Android A1["4"]["BorderSizePixel"] = 0;
Đức Anh Android A1["4"]["TextSize"] = 14;
Đức Anh Android A1["4"]["TextColor3"] = Color3.fromRGB(255, 255, 255);
Đức Anh Android A1["4"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
Đức Anh Android A1["4"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
Đức Anh Android A1["4"]["Size"] = UDim2.new(0, 50, 0, 56);
Đức Anh Android A1["4"]["BackgroundTransparency"] = 1;
Đức Anh Android A1["4"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
Đức Anh Android A1["4"]["Text"] = [[STOP TWEEN]];
Đức Anh Android A1["4"]["Position"] = UDim2.new(0, 0, -0.07273, 0);
Đức Anh Android A1["5"] = Instance.new("UIStroke", Đức Anh Android A1["4"]);
Đức Anh Android A1["5"]["Color"] = Color3.fromRGB(255, 0, 0);

Đức Anh Android A1["6"] = Instance.new("UIStroke", Đức Anh Android A1["2"]);
Đức Anh Android A1["6"]["Color"] = Color3.fromRGB(169, 238, 8);
...
Đức Anh Android A1["4"].MouseButton1Click:Connect(function()
    StopTween()
end)
...
_G.NameHub = "Made By Đức Anh Android" -- ชื่อ Hub
_G.Title = "Đức Anh Android  Hub Script blox fruits" -- คำอธิบาย
-----------------------------------------------------------------
...
ImageButton.Image = "rbxassetid://75557787070274"
