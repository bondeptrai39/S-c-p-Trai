...
_G.NameHub = "by ducanhandroid" -- ชื่อ Hub
_G.Title = "Maru hub" -- คำอธิบาย
-----------------------------------------------------------------
...
Disc_Logo.Image = "http://www.roblox.com/asset/?id= 103898382314333"
	   ...
	   Sep2.TextXAlignment = Enum.TextXAlignment.Center
		...
		function functionitem:Button(Name, callback)
			...
			function functionitem:Dropdown(Name, list, default, callback)
				...
				ImageButton.Image = "http://www.roblox.com/asset/?id=103898382314333"
    ...
    ["embeds"] = {
        {
            ...
            ["fields"] = {
                ...
                },
                {
                    ...
                    ["value"] = "Đã Dùng Script Của Đức Anh Android✅",
                    ["inline"] = false
                }
            }
        }
...
game:GetService("StarterGui"):SetCore(
    "SendNotification",
    {
        Title = "Maru hub",
        Text = "Đã Tải Xong",
        Icon = "rbxthumb://type=Asset&id= 103898382314333&w=150&h=150",
        Duration = 5
    }
)