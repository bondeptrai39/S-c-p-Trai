...
function Library:CreateWindow(info)
	...
	local Icon = info.Icon or info.icon or "123709024751036" 
	...
	if type(Icon) == 'string' and not Icon:find('rbxassetid://105623339332869') then
		Logo_1.Image = "rbxassetid://105623339332869"
	...
	ToggleUI.Parent = Excusyz
	ToggleUI.Active = true
	ToggleUI.AnchorPoint = Vector2.new(0.5, 0.5)
	ToggleUI.BackgroundColor3 = Color3.fromRGB(58,58,58)
	ToggleUI.BorderColor3 = Color3.fromRGB(0,0,0)
	ToggleUI.BorderSizePixel = 0
	ToggleUI.Position = UDim2.new(0.0909999982, 0,0.186000004, 0)
	...
	if type(Icon) == 'string' and not Icon:find('rbxassetid://105623339332869') then
		ToggleIcon.Image = "rbxassetid://105623339332869"
	elseif type(Icon) == 'number' then
		ToggleIcon.Image = "rbxassetid://105623339332869"
	else
		ToggleIcon.Image = Icon
	end
	ToggleIcon.ImageTransparency = 1

	BackgroundGradient_1.Name = "BackgroundGradient"
	BackgroundGradient_1.Parent = ToggleUI
	...
	local isopen = false
	local oripos = ToggleUI.Position
...
function Library.Section:CreateSection(info)
    ...
    Section_1.BackgroundColor3 = Color3.fromRGB(35, 35, 40)
    Section_1.BorderColor3 = Color3.fromRGB(0, 0, 0)
    Section_1.BorderSizePixel = 0
    Section_1.Position = UDim2.new(0.005, 0, 0.025, 0)
    ...
    SectionTitle_1.TextSize = 11

    Line_2.Name = "Line"
    Line_2.Parent = Section_1
    Line_2.BackgroundColor3 = Color3.fromRGB(100, 100, 110)
    Line_2.BackgroundTransparency = 0.4
    ...
    Toggle_1.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
    Toggle_1.BackgroundTransparency = 0.2
    ...
    ToggleO_1.BackgroundColor3 = Value and Color3.fromRGB(0, 170, 255) or Color3.fromRGB(50, 50, 50)
    ...
    done_1.Size = UDim2.new(0.9, 0, 0.9, 0)
    done_1.ZIndex = 2
    ...
    return NewValue
            ...
            function Library.Main:CreateDropdown(info)
				...
				Title_8.Text = Title
				Title_8.TextColor3 = Color3.fromRGB(200, 200, 200)
				Title_8.TextSize = 9
				...
				DropdownBar_1.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
				...
				DropdownIcon_1.BackgroundColor3 = Color3.fromRGB(180, 180, 180)
				...
				DropdownItem_1.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
				...
				ScrollingFrame_2.ScrollBarImageColor3 = Color3.fromRGB(100, 100, 100)
				...
				function itemslist:AddList(text)
					...
					Item_1.MouseButton1Click:Connect(function()
						if Multi then
							if selectedvalue[text] then
								selectedvalue[text] = nil
								Tw({
									v = Item_1,
									t = 0.15,
									s = "Back",
							...
							local selectedList = {}
							for i, v in pairs(selectedvalue) do
...
function Library.Main:CreateSlider(info)
    local Title = info.Name or info.name or info.Title or info.title or "Slider"
    ...
    SliderText_1.AnchorPoint = Vector2.new(0.5, 0)
    SliderText_1.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
    SliderText_1.BackgroundTransparency = 1
    SliderText_1.BorderColor3 = Color3.fromRGB(0, 0, 0)
    SliderText_1.BorderSizePixel = 0
    SliderText_1.Position = UDim2.new(0.5, 0, 0, 0)
    SliderText_1.Size = UDim2.new(0.9, 0, 0, 20)
    ...
    Title_7.Text = Title
    Title_7.TextColor3 = Color3.fromRGB(200, 200, 200)
    Title_7.TextSize = 10
    ...
    SliderBar_1.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
    SliderBar_1.BackgroundTransparency = 0
    SliderBar_1.BorderColor3 = Color3.fromRGB(0, 0, 0)
    SliderBar_1.BorderSizePixel = 0
    SliderBar_1.Position = UDim2.new(0.05, 0, 0.75, 0)
    SliderBar_1.Size = UDim2.new(0.65, 0, 0, 4)

    SliderBarValue_1.Name = "SliderBarValue"
    SliderBarValue_1.Parent = SliderBar_1
    SliderBarValue_1.BackgroundColor3 = Color3.fromRGB(100, 100, 255)
    ...
    Click_3.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
    ...
    Click_3.Size = UDim2.new(1, 20, 1, 20)
    Click_3.Font = Enum.Font.SourceSans
    Click_3.Text = ""
    Click_3.TextSize = 14

    UIGradient_1.Parent = SliderBar_1
    UIGradient_1.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(50, 50, 50)), ColorSequenceKeypoint.new(1, Color3.fromRGB(30, 30, 30))}

    SliderValueBox_1.Name = "SliderValueBox"
    SliderValueBox_1.Parent = Slider_1
    SliderValueBox_1.AnchorPoint = Vector2.new(1, 0.5)
    SliderValueBox_1.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
    SliderValueBox_1.BackgroundTransparency = 0
    SliderValueBox_1.BorderColor3 = Color3.fromRGB(0, 0, 0)
    SliderValueBox_1.BorderSizePixel = 0
    SliderValueBox_1.LayoutOrder = -1
    SliderValueBox_1.Position = UDim2.new(0.95, 0, 0.75, 0)
    SliderValueBox_1.Size = UDim2.new(0, 40, 0, 18)
    ...
    TextBox_1.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
    TextBox_1.BackgroundTransparency = 1
    TextBox_1.BorderColor3 = Color3.fromRGB(0, 0, 0)
    TextBox_1.BorderSizePixel = 0
    TextBox_1.Size = UDim2.new(0.9, 0, 0.8, 0)
    ...
    local function updateSlider(value)
        ...
        local relativeSize = (value - Min) / (Max - Min)
        SliderBarValue_1.Size = UDim2.new(relativeSize, 0, 1, 0)
        TextBox_1.Text = tostring(math.floor(value)) .. Textending
        TextBox_1.Size = UDim2.new(0, math.max(TextBox_1.TextBounds.X + 5, 20), 0.8, 0)
        Callback(value)
    end
    ...
    TextBox_1.FocusLost:Connect(function(enterPressed)
        if enterPressed then
            local inputValue = tonumber(TextBox_1.Text:match("%d+")) or Value
    ...
    Click_3.InputBegan:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
            dragging = true
            local relativeX = math.clamp((input.Position.X - SliderBar_1.AbsolutePosition.X) / SliderBar_1.AbsoluteSize.X, 0, 1)
    ...
    game:GetService("UserInputService").InputChanged:Connect(function(input)
        if dragging and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
            local relativeX = math.clamp((input.Position.X - SliderBar_1.AbsolutePosition.X) / SliderBar_1.AbsoluteSize.X, 0, 1)
            local value = Min + relativeX * (Max - Min)
            if math.abs(value - lastValue) >= 0.1 then -- Giảm độ khựng
                updateSlider(value)
                lastValue = value
            end
        end
...
function Library.Main:CreateParagraph(info)
    local Title = info.Title or info.title or "Paragraph"
    local Content = info.Content or info.content or ""
    local Center = info.Center or false -- Support for Center property, default to false
    ...
    TitleLabel.TextXAlignment = Center and Enum.TextXAlignment.Center or Enum.TextXAlignment.Left
    ...
    ContentLabel.TextXAlignment = Center and Enum.TextXAlignment.Center or Enum.TextXAlignment.Left
    ...
    local function updateParagraphSize()
        local titleSize = game:GetService("TextService"):GetTextSize(
            ...
            TitleLabel.TextSize,
            TitleLabel.Font,
            Vector2.new(Paragraph.AbsoluteSize.X - 10, math.huge)
        )
        ...
        TitleLabel.Size = UDim2.new(1, -10, 0, titleSize.Y)
        ContentLabel.Size = UDim2.new(1, -10, 0, contentSize.Y)
        Paragraph.Size = UDim2.new(0.9, 0, 0, titleSize.Y + contentSize.Y + 15)
    end
    ...
    local ParagraphObj = {}
    function ParagraphObj:Set(newInfo)
        if newInfo.Title and type(newInfo.Title) == "string" then
            TitleLabel.Text = newInfo.Title
        end
        if newInfo.Content and type(newInfo.Content) == "string" then
            ContentLabel.Text = newInfo.Content
        end
        updateParagraphSize()
    end
...
function Library.Main:CreateLabel(info)
    local Title = info.Name or info.name or info.Title or info.title or info.Text or info.text or "Label"

    local TextLabel_2 = Instance.new("Frame")
    local Title_10 = Instance.new("TextLabel")

    TextLabel_2.Name = "TextLabel"
    TextLabel_2.Parent = Section_1 or game.Players.LocalPlayer.PlayerGui
    TextLabel_2.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
    TextLabel_2.BackgroundTransparency = 0.2
    TextLabel_2.BorderSizePixel = 0
    TextLabel_2.LayoutOrder = 2
    TextLabel_2.Size = UDim2.new(0.9, 0, 0, 25)
...
function Library.Main:CreateTextBox(info)
	local Title = info.Name or info.name or info.Title or info.title or info.Text or info.text or "Title"
	local Placeholder = info.Placeholder or info.placeholder or "Enter text..."
	local Value = info.Value or info.value or nil
	...
	TextBoxBar_1.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
	TextBoxBar_1.Position = UDim2.new(0.5, 0, 0.7, 0)
	TextBoxBar_1.Size = UDim2.new(0.9, 0, 0, 22)
	...
	TextBoxValue_1.Size = UDim2.new(0.9, 0, 1, 0)
	TextBoxValue_1.Font = Enum.Font.Gotham
	TextBoxValue_1.PlaceholderColor3 = Color3.fromRGB(160, 160, 160)
	TextBoxValue_1.PlaceholderText = Placeholder
	TextBoxValue_1.Text = Value or ""
	TextBoxValue_1.TextColor3 = Color3.fromRGB(220, 220, 220)
	TextBoxValue_1.TextSize = 11
	...
	Title_1.Size = UDim2.new(0.9, 0, 0, 18)
	Title_1.Font = Enum.Font.GothamBold
	Title_1.Text = Title
...
Set = Window:CreateTab({
	Title = "Settings",
	Icon = "rbxassetid://10734950309"
})
Settings = Set:CreateSection({
	Title = "Settings",
	Side = "Left"
})

Status = Set:CreateSection({
	Title = "Status Number",
	Side = "Right"
})
Set = Main:CreateSection({
	Title = "Auto Main Farm",
	Side = "Left"
})

Mics = Main:CreateSection({
	Title = "Status Sever",
	Side = "Right"
})
...
DragonDojo = Items:CreateSection({
	Title = "Dragon Dojo",
	Side = "Right"
})

Items1 = Items:CreateSection({
	Title = "Farm Item",
	Side = "Left"
})
Getsword = Items:CreateSection({
...
SeaEvent1 = Event:CreateSection({
	Title = "Volcano Events",
	Side = "Left"
})
SeaEvent2 = Event:CreateSection({
	Title = "Kitsune Events",
	Side = "Right"
})
SeaEvent3 = Event:CreateSection({
	Title = "Sea Events",
	Side = "Right"
})
SeaEvent4 = Event:CreateSection({
	Title = "Mirage Island",
	Side = "Right"
})
Race1 = Race:CreateSection({
	Title = "Race",
	Side = "Left"
})
Raid1 = Race:CreateSection({
	Title = "Raid",
	Side = "Right"
})
Raid2 = Race:CreateSection({
	Title = "Law",
	Side = "Right"
})
...
Fruit1 = Fruit:CreateSection({
	Title = "Fruit",
	Side = "Left"
})
Teleport1 = Fruit:CreateSection({
	Title = "Travel",
	Side = "Right"
})
AutoEsp = Window:CreateTab({
	Title = "Player - Esp",
	Icon = "rbxassetid://7251993295"
})
Player1 = AutoEsp:CreateSection({
	Title = "Player",
	Side = "Left"
})
Esp2 = AutoEsp:CreateSection({
	Title = "Esp",
	Side = "Right"
})
Shopee = Window:CreateTab({
	Title = "Shop - Misc",
	Icon = "rbxassetid://10734952479"
})
Shop = Shopee:CreateSection({
	Title = "Shop",
	Side = "Left"
})
Misc = Shopee:CreateSection({
	Title = "",
	Side = "Right"
})
...
Chest = Main:CreateSection({
	Title = "Auto Farm Chest and Berry",
	Side = "Left"
})
Chest:CreateToggle({
    Title = "Farm Chest",
...
function FindWeapon(category)
    local Backpack = game.Players.LocalPlayer.Backpack
    for _, tool in ipairs(Backpack:GetChildren()) do
        if tool:IsA("Tool") then
            if category == "Melee" and (tool.ToolTip == "Melee" or tool.Name == "Combat") then
                return tool.Name
            elseif category == "Sword" and tool.ToolTip == "Sword" then
                return tool.Name
            elseif category == "Gun" and tool.ToolTip == "Gun" then
                return tool.Name
            elseif category == "Fruit" and tool.ToolTip == "Blox Fruit" then
                return tool.Name
            end
        end
    end
...
task.spawn(function()
    while task.wait(1) do
        if _G.Farm8Binhs then
            for _, cframe in ipairs(BinhsCFrame) do
                if not _G.Farm8Binhs then
                    break
                end
                TweenToPosition(cframe * CFrame.new(0, 5, 0))
                task.wait(0.5)
                AttackAllSkills()
                task.wait(3)
            end
...
local BoneCheck = Mics:CreateParagraph({
    Title = "Check Bone",
    Content = ""
})
    ...
    while wait(1) do 
        pcall(function()
            ...
            BoneCheck:Set({
                ["Title"] = "Bone Farm",
                ["Content"] = "Check Bone You Have: " .. tostring(bones)
            })
        end)
    end
end)

local CakePrinceStatus = Mics:CreateParagraph({
        ...
        pcall(function()
            ...
            if string.len(response) == 88 then
                CakePrinceStatus:Set({
                    ...
                    ["Content"] = "Killed : " .. string.sub(response, 39, 41) .. " / 500"
                })
            elseif string.len(response) == 87 then
                CakePrinceStatus:Set({
                    ["Title"] = "Cake Prince Status",
                    ["Content"] = "Killed : " .. string.sub(response, 39, 40) .. " / 500"
                })
            elseif string.len(response) == 86 then
                CakePrinceStatus:Set({
                    ["Title"] = "Cake Prince Status",
                    ["Content"] = "Killed : " .. string.sub(response, 39, 39) .. " / 500"
                })
            else
                CakePrinceStatus:Set({
                    ["Title"] = "Cake Prince Status",
                    ["Content"] = "Prince King Spawned ✅"
                })
            end
        end)
    end
...
local EyesCheck = Mics:CreateParagraph({
...
task.spawn(function()
    pcall(function()
        while task.wait(1) do
            ...
            if activeEyes == 1 then
                EyesCheck:Set({
                    ["Title"] = "Check Eyes Status",
                    ["Content"] = "Status: 1 Eye"
                })
            elseif activeEyes == 2 then
                EyesCheck:Set({
                    ["Title"] = "Check Eyes Status",
                    ["Content"] = "Status: 2 Eyes"
                })
            elseif activeEyes == 3 then
                EyesCheck:Set({
                    ["Title"] = "Check Eyes Status",
                    ["Content"] = "Status: 3 Eyes"
                })
            elseif activeEyes == 4 then
                EyesCheck:Set({
                    ["Title"] = "Check Eyes Status",
                    ["Content"] = "Status: 4 Eyes 🟢"
                })
            else
                EyesCheck:Set({
                    ["Title"] = "Check Eyes Status",
                    ["Content"] = "Status: No Eyes"
                })
            end
        end
    end)
...
local MirageCheck = Mics:CreateParagraph({
    ...
    pcall(function()
        while task.wait(1) do
            if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
                MirageCheck:Set({
                    ["Title"] = "Check Mirage Island",
                    ["Content"] = "Mirage Island is Spawning ✅"
                })
            else
                MirageCheck:Set({
                    ["Title"] = "Check Mirage Island",
                    ["Content"] = "Mirage Island Not Spawn ❌"
                })
            end
        end
    end)
...
local PrehistoricCheck = Mics:CreateParagraph({
    ...
    while task.wait(1) do
        pcall(function()
            if game:GetService("Workspace").Map:FindFirstChild("PrehistoricIsland") then
                PrehistoricCheck:Set({
                    ["Title"] = "Check Prehistoric Island",
                    ["Content"] = "Prehistoric Island: Spawning ✅"
                })
            else
                PrehistoricCheck:Set({
                    ["Title"] = "Check Prehistoric Island",
                    ["Content"] = "Prehistoric Island: Not Spawning ❌"
                })
            end
        end)
    end
...
local KitsuneCheck = Mics:CreateParagraph({
    ...
    pcall(function()
        while task.wait(1) do
            if game:GetService("Workspace").Map:FindFirstChild("KitsuneIsland") then
                KitsuneCheck:Set({
                    ["Title"] = "Check Kitsune Island",
                    ["Content"] = "Kitsune Island Spawning ✅"
                })
            else
                KitsuneCheck:Set({
                    ["Title"] = "Check Kitsune Island",
                    ["Content"] = "Kitsune Island Not Spawning ❌"
                })
            end
        end
    end)
...
local Time = Mics:CreateParagraph({
    Title = "Executor Time",
    Content = "Initializing..."
})
...
local function UpdateTime()
    ...
    Time:Set({
        ["Title"] = "Executor Time",
        ["Content"] = "[Time] : Hours : " .. Hour .. " Min : " .. Minute .. " Sec : " .. Second
    })
end
...
local Client = Mics:CreateParagraph({
    Title = "Client",
    Content = "Initializing..."
})
...
local Client1 = Mics:CreateParagraph({
    Title = "Client",
    Content = "Initializing..."
})

local function UpdateClient1()
    local Ping = game:GetService("Stats").Network.ServerStatsItem["Data Ping"]:Getvaluetring()
    Client1:Set({
        ["Title"] = "Client",
        ["Content"] = "[Ping] : " .. Ping
    })
...
BossFarm:CreateDropdown({
 ...
 local BossSpawn = BossFarm:CreateParagraph({
    ...
    while task.wait(1) do
        pcall(function()
            if game:GetService("ReplicatedStorage"):FindFirstChild(_G.SelectBoss) or game:GetService("Workspace").Enemies:FindFirstChild(_G.SelectBoss) then
                BossSpawn:Set({
                    ["Title"] = "Boss Spawn Status",
                    ["Content"] = "Status: Boss Spawn ✅"
                })
            else
                BossSpawn:Set({
                    ["Title"] = "Boss Spawn Status",
                    ["Content"] = "Status: Boss Not Spawn ❌"
                })
            end
        end)
    end
end)
    BossFarm:CreateToggle({
    Title = "Farm Boss",
    Value = false,
    Callback = function(value)
     _G.AutoBoss = value
...
MaterialFarm = Main:CreateSection({
	Title = "Auto Farm Materia",
	Side = "Left"
})
...
spawn(function()
	while wait(0.2) do
		if _G.AutoFarmMaterial then
			pcall(function()
				getConfigMaterial(_G.SelectBoss);
				for i, mon in pairs(MaterialMon) do
					if (game:GetService("Workspace")).Enemies:FindFirstChild(mon) then
						...
						if Distance > 18000 and _G.SelectBoss == "Ectoplasm" then
							(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(923.21252441406, 126.9760055542, 32852.83203125));
						end;
						topos(MaterialPos);
					end;
...
Items1:CreateToggle({
    Title = "Kill Dark Beard",
    Value = false,
    Callback = function(value)
     _G.AutoDarkBoss = value
                    ...
                    if v.Name == "Cursed Skeleton Boss" and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                        ...
                        elseif not hasNotified then
                            game.StarterGui:SetCore("SendNotification", {
                                ...
                                con = "rbxassetid://100448459951264",
                                Duration = 10,
                            })
                            hasNotified = true
                        end
...
DragonMobClear=function(a,b,c)if workspace.Enemies:FindFirstChild(b)then for d,e in pairs(workspace.Enemies:GetChildren())do if e.Name==b and Attack.Alive(e)then if a then Attack.Kill(e,a)end end end else topos(c)end end
spawn(function()
  while wait() do 
        ...
        if a == true and not BackTODoJo() then
          ...
          elseif x == 2 then
            if workspace.Map.Waterfall.IslandModel:FindFirstChild("Meshes/bambootree", true) then
              repeat wait()                
                spawn(function() topos(workspace.Map.Waterfall.IslandModel:FindFirstChild("Meshes/bambootree", true).CFrame * CFrame.new(4,0,0)) end)
...
while wait() do 
 ...
 spawn(function()
  ...
  spawn(function()
    ...
    Race1:CreateToggle({
    Title = "Auto Kill Player Trailer V4",
    Value = false,
    Callback = function(Value)      
        _G.AutoKillV4 = Value
        end})
spawn(function()
            ...
            pcall(function()
                for i, v in pairs(game.Workspace.Characters:GetChildren()) do
                    if v.Name ~= game.Players.LocalPlayer.Name then
                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and v.Parent and
                            (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v.HumanoidRootPart.Position).Magnitude <= 230 then
                            repeat task.wait()
                                AutoHaki()
                                EquipWeapon(_G.SelectWeapon)
                                ...
                                v.Humanoid.WalkSpeed = 0
                                sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
                            until not _G.AutoKillV4 or v.Humanoid.Health <= 0 or not v.Parent or not v:FindFirstChild("HumanoidRootPart") or not v:FindFirstChild("Humanoid")
                        end
                    end
                end
            end)
 ...
 Raid1:CreateDropdown({
	Title = "Select Chip",
	List = {"Flame","Ice","Sand","Dark","Light","Magma","Quake","Buddha","Spider","Phoenix","Rumble","Dough"},
	Multi = false,
	Value = "Flame",
	Callback = function(value)
		_G.SelectWeapon = value
        ...
        if getgenv().AutoStoreFruit then
            pcall(function()
                ...
                for _, fruit in ipairs(fruits) do
                    ...
                    local tool = backpack:FindFirstChild(fruitName) or character:FindFirstChild(fruitName)
                    if tool then
...
if World1 then
 Teleport1:CreateDropdown({
	Title = "Select Island",
	List = {"WindMill","Marine","Middle Town","Jungle","Pirate Village","Desert","Snow Island","MarineFord","Colosseum","Sky Island 1","Sky Island 2","Sky Island 3","Prison","Magma Village","Under Water Island","Fountain City","Shank Room","Mob Island"},
	Multi = false,
	Value = "WindMill",
	Callback = function(Value)
...
if World2 then
 Teleport1:CreateDropdown({
	Title = "Select Island",
	List = {"The Cafe","Frist Spot","Dark Area","Flamingo Mansion","Flamingo Room","Green Zone","Factory","Colossuim","Zombie Island","Two Snow Mountain","Punk Hazard","Cursed Ship","Ice Castle","Forgotten Island","Ussop Island","Mini Sky Island"},
	Multi = false,
	Value = "The Cafe",
	Callback = function(Value)
		_G.SelectIsland = Value
...
if World3 then
 Teleport1:CreateDropdown({
	Title = "Select Island",
	List = {"Mansion","Port Town","Great Tree","Castle On The Sea","MiniSky","Hydra Island","Floating Turtle","Haunted Castle","Ice Cream Island","Peanut Island","Cake Island","Cocoa Island","Candy Island","Tiki Outpost"},
	Multi = false,
	Value = "Mansion",
	Callback = function(Value)
		_G.SelectIsland = Value
...
local SelectedPly = Player1:CreateDropdown({
    Title = "Player List",
    List = PlayerList,
    Multi = false,
...
Player1:CreateButton({
    ...
    Callback = function()
        ...
        if SelectedPly and SelectedPly.Refresh then
            SelectedPly:Refresh(NewPlayerList)
        else
            warn("Dropdown không hỗ trợ .Refresh, cần kiểm tra thư viện GUI bạn dùng.")
        end
    end
})

  Player1:CreateToggle({
        ...
        if SpectatePlys then
            task.spawn(function()
                while SpectatePlys do
                    local target = game.Players:FindFirstChild(SelectPly)
...
spawn(function()
    while wait() do
        if _G.TeleportPly then
            pcall(function()
                local target = game:GetService("Players")[SelectPly]
                        ...
                        if game.Players:FindFirstChild(SelectPly) then
                            if game.Players:FindFirstChild(SelectPly).Character.Humanoid.Health > 0 then
                                repeat task.wait()
                                    ...
                                    topos(game.Players:FindFirstChild(SelectPly).Character.HumanoidRootPart.CFrame * CFrame.new(0,5,0))
                                    spawn(function()
                                        pcall(function()
                                ...
                                until game.Players:FindFirstChild(SelectPly).Character.Humanoid.Health <= 0 or not game.Players:FindFirstChild(SelectPly) or not _G.AutoKillPlayer
                            end
                        end
                    end
                end)
...
spawn(function()
    while wait() do
        if player.Data.Points.Value >= PointStats then
            ...
            if melee then AddStat("Melee") end
            if defense then AddStat("Defense") end
            if sword then AddStat("Sword") end
            if gun then AddStat("Gun") end
            if demonfruit then AddStat("Demon Fruit") end
        end
    end
end)
